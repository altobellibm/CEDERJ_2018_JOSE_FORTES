...
namespace ds {
    ...
    void dual_scaling(
        ...
        std::ofstream file("C:/Users/altobelli/Documents/TesteBases/base artigo/F.txt");
            file << F;
        file.close();
        ...
        file.open("C:/Users/altobelli/Documents/TesteBases/base artigo/M.txt");
            file << M;
        file.close();
        ...
        std::cout << "Chegou dual scaling" << std::endl;

		Eigen::MatrixXcd Vi = VSort.block(0, 1, AV.rows(), maxDimensao-1); //elimina a primeira e as ultimas dimensões.
        ...
        file.open("C:/Users/altobelli/Documents/TesteBases/base artigo/autovetor.txt");
            file << V;
        file.close();

        file.open("C:/Users/altobelli/Documents/TesteBases/base artigo/autovalor.txt");
           file << D;
        file.close();
        ...
        file.open("C:/Users/altobelli/Documents/TesteBases/base artigo/T.txt");
           file << T;
        file.close();
        ...
        file.open("C:/Users/altobelli/Documents/TesteBases/base artigo/delta.txt");
            file << delta;
        file.close();
